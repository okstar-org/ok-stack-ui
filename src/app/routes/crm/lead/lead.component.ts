...
export class LeadComponent implements OnInit, OnDestroy {
  ...
  columns: MtxGridColumn[] = [
    {
      header: this.translate.stream('crm.lead.customerName'),
      field: 'customerName',
      sortable: true,
    },
    {
      header: this.translate.stream('crm.lead.contactName'),
      field: 'contactName',
      sortable: true,
    },
    {
      header: this.translate.stream('crm.lead.mobilePhone'),
      field: 'mobilePhone',
      sortable: true,
    },
    {
      header: this.translate.stream('crm.lead.ownerName'),
      field: 'ownerName',
      sortable: true,
    },
    {
      header: this.translate.stream('crm.lead.source'),
      field: 'source',
      sortable: true,
    },
    {
      header: this.translate.stream('crm.lead.status'),
      field: 'status',
      sortable: true,
    },
    {
      header: this.translate.stream('crm.lead.lastFollowUpTime'),
      field: 'lastFollowUpTime',
      sortable: true,
      type: 'date',
    },
    {
      header: this.translate.stream('crm.lead.unFollowUpDays'),
